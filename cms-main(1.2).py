...
def classprofile():#classprofile
    ...
    def cperformance():
        ...
        def ok():
            ...
            if exam=='-select-':
                ...
                cpf.title('Class Performance-Manipal')
        ...
        cp=Toplevel()
        cp.geometry('300x200')
        cp.title('Class Performance-Manipal')
    ...
    def sreport(): #student report
        def report():
            ...
            if stname=='-select-':
                ...
                rep.title('Student Report-Manipal')
    ...
    cprofile.title('classprofile-Manipal')
...
def accwindow():#mainprofile
    ...
    dash.title('HomePage-Manipal')
    dash['bg'] = '#c2edc0'
    s=StringVar()
    Button(dash,text='SignOut',command=signout).grid(row=1,column=3)
    Label(dash,text='Your DashBoard',font='Helvetica 12 bold',bg='#c2edc0').grid(row=1,column=2)
    Label(dash,text='Your Name: '+finaln,bg='#c2edc0').grid(row=2,column=1)
    Label(dash,text='Email: '+email,bg='#c2edc0').grid(row=3,column=1)
    Label(dash,text='No. of classes:'+co,bg='#c2edc0').grid(row=4,column=1)
    Button(dash,text='Create New Class',command=newclass).grid(row=5,column=1)
    Label(dash,text='Select Class>>>>',bg='#c2edc0').grid(row=6,column=1)
...
def sign():
    ...
    pas=StringVar()
    sign=Toplevel()
    sign.title('SignIn/CreateAccount-Manipal')
    sign.geometry('400x400')
    Label(sign,text='Sign In',font='Helvetica 12 bold').grid(row=1,column=2)
    Button(sign,text='CreateAccount',command=account,bg='#c0c4ed').grid(row=1,column=3)
    ...
    Button(sign,text='Proceed',command=proceed1,bg='#c0c4ed').grid(row=4,column=3)
...
home.title('Student Performance Tracker - Home ')
Label(home,text='---HOME PAGE---',font='Helvetica 12 bold',bg='#c5edc0').grid(row=1,column=4)
#Label(home,text='MIT Manipal',bg='#c2edc0').grid(row=1,column=4)
Button(home,text='SignIn/Create Account',command=sign,bg='#c0c4ed').grid(row=3,column=4)

Button(home,text='Subject Projection',command=subpro,bg='#c0c4ed').grid(row=5,column=4)

Button(home,text='percentage calculator',command=calculator,bg='#c0c4ed').grid(row=7,column=4)
Label(home,text='',bg='#c2edc0').grid(row=5,column=3)
Label(home,text='**sign in/create account to Start',bg='#c2edc0').grid(row=8,column=4)
Label(home,text='',bg='#c2edc0').grid(row=7,column=3)
Label(home,text='when moving to other windows, do not close this main window',bg='#c2edc0').grid(row=9,column=4)
Label(home,text='',bg='#c2edc0').grid(row=9,column=3)
Label(home,text='MIT Manipal😀',bg='#c2edc0').grid(row=10,column=4)
home.mainloop()
